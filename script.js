...
function checkForWin() {
    ...
    if (winner) {  // setTimeout == verzögerung beim laden
        console.log('gewonnen', winner);
        gameOver = true;
        setTimeout(function () {
            document.getElementById('end-screen').classList.remove('d-none');
            document.getElementById('end-button').classList.remove('d-none');
        }, 1000);
    }
...
function restartGame() {
    ...
    document.getElementById('end-button').classList.add('d-none');
